...
public class IWebServiceApi {
    ...
    private FileWriter writeImportsAndStructureOfClassInApis(Project project, BuisnessLogicEntity ent) throws IOException {
        ...
        File file = new File(ConstantsPath.DESKTOP.concat(project.getNameProject()).concat(ConstantsPath.PATH_TO_PROJECT_IWEBSERVICEAPI).concat(fileInterfaceApi).concat(".java"));
    ...
    private void signatureUpdateApi(BuisnessLogicEntity ent, FileWriter myWriter, String fileDto) throws IOException {
        ...
        myWriter.write(ConstantsAnnotations.ANNOTATION_REQUEST_MAPPING.concat(Constants.PARENTHESE_VALUE_EGALE).concat(Constants.DOUBLE_COTE).concat(Constants.PATTERN_SLASH)
                ...
                .concat(Constants.ACCOLADE_FERMANTE).concat(Constants.DOUBLE_COTE).concat(Constants.VIRGULE).concat(Constants.METHOD_EGALE).concat(Constants.REQUEST_METHOD_POINT)
                .concat(Constants.PUT).concat(Constants.PARENTHESE_FERMANTE));
    ...
    private void signatureDeleteApi(BuisnessLogicEntity ent, FileWriter myWriter) throws IOException {
        ...
        myWriter.write(ConstantsAnnotations.ANNOTATION_REQUEST_MAPPING.concat(Constants.PARENTHESE_VALUE_EGALE).concat(Constants.DOUBLE_COTE).concat(Constants.PATTERN_SLASH)
                .concat(ent.getNameEntity().toLowerCase()).concat(Constants.PATTERN_SLASH).concat(Constants.ACCOLADE_OUVRANT).concat(Constants.ID_MINUS)
                .concat(Constants.ACCOLADE_FERMANTE).concat(Constants.DOUBLE_COTE).concat(Constants.VIRGULE).concat(Constants.METHOD_EGALE).concat(Constants.REQUEST_METHOD_POINT)
                .concat(Constants.DELETE).concat(Constants.PARENTHESE_FERMANTE));
    ...
    private void signatureGetApi(BuisnessLogicEntity ent, FileWriter myWriter) throws IOException {
        ...
        myWriter.write(ConstantsAnnotations.ANNOTATION_REQUEST_MAPPING.concat(Constants.PARENTHESE_VALUE_EGALE).concat(Constants.DOUBLE_COTE).concat(Constants.PATTERN_SLASH)
                .concat(ent.getNameEntity().toLowerCase()).concat(Constants.PATTERN_SLASH).concat(Constants.ACCOLADE_OUVRANT).concat(Constants.ID_MINUS)
                .concat(Constants.ACCOLADE_FERMANTE).concat(Constants.DOUBLE_COTE).concat(Constants.VIRGULE).concat(Constants.METHOD_EGALE).concat(Constants.REQUEST_METHOD_POINT)
                .concat(Constants.GET).concat(Constants.PARENTHESE_FERMANTE));
        ...
        myWriter.write(
                Constants.RESPONSE_ENTITY.concat("get").concat(ent.getNameEntity()).concat(Constants.PARENTHESE_OUVRANTE).concat(AttributesTypeEnum.Long.toString().toLowerCase())
                        .concat(" ").concat(Constants.ID_MINUS).concat(Constants.PARENTHESE_FERMANTE).concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE));
    ...
    private void signatureSaveApi(BuisnessLogicEntity ent, FileWriter myWriter, String fileCreateDto, String fileViewDto) throws IOException {
        ...
        myWriter.write(ConstantsAnnotations.ANNOTATION_SWAGGER_API_RESPONSE.concat(Constants.PARENTHESE_CODE_EGALE).concat(Constants.API_STATUS_ACCEPTED).concat(Constants.VIRGULE)
                .concat(Constants.API_MESSAGE).concat(ent.getNameEntity().toUpperCase()).concat(Constants._CREATED_SUCCESSFULLY).concat(Constants.VIRGULE)
        ...
        myWriter.write(Constants.PATTERN_TABULATION);
        myWriter.write(ConstantsAnnotations.ANNOTATION_REQUEST_MAPPING.concat(Constants.PARENTHESE_VALUE_EGALE).concat(Constants.DOUBLE_COTE).concat(Constants.PATTERN_SLASH)
                .concat(ent.getNameEntity().toLowerCase()).concat(Constants.DOUBLE_COTE).concat(Constants.VIRGULE).concat(Constants.METHOD_EGALE)
