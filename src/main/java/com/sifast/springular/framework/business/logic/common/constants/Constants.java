...
public class Constants {
    ...
    public static final String VALUE_EGALE = " value = ";

    public static final String NAME_EGALE = " name = ";

    public static final String TRY = "try";

    public static final String METHOD_VALIDATE_INPUT_DATA = "validateInputData";
    ...
    public static final String CATCH_LOGGER_ERROR = "LOGGER.error(ApiMessage.ERROR_LEVEL_MESSAGE, ex);\n";

    public static final String HTTP_STATUS_CREATED = "httpStatus = HttpStatus.CREATED;\n";

    public static final String VARIABLE_HTTP_RESPONSE_BODY = "httpResponseBody";

    public static final String FIND_BY_IN = "findByIdIn";
