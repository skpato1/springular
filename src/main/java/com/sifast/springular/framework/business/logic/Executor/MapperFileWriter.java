...
public class MapperFileWriter {
    ...
    private void ifConditionIsInstanceOfChildren(FileWriter myWriter, BuisnessLogicEntity ent, String entityToRetrieve, String entryVariable, String variableToSet)
            throws IOException {
        myWriter.write(Constants.PATTERN_TABULATION);
        myWriter.write(Constants.PATTERN_TABULATION);
    ...
    private void initializeVariableToRetrieveChildId(FileWriter myWriter) throws IOException {
        ...
        myWriter.write(Constants.PATTERN_TABULATION);
        myWriter.write(Constants.PATTERN_TABULATION);
        myWriter.write(Constants.INT.concat(" ").concat(idToInitialize).concat(Constants.EGALE).concat("0").concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE));
    ...
    private void implementationOfMapVersionWithoutEntity(FileWriter myWriter, String entryVariable, String result) throws IOException {
        ...
        myWriter.write(result.concat(Constants.POINT).concat(Constants.SET_AUTHOR).concat(Constants.PARENTHESE_OUVRANTE).concat(entryVariable).concat(Constants.POINT)
                .concat(Constants.GET_AUTHOR).concat(Constants.PARENTHESE_FERMANTE).concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE));
        ...
        myWriter.write(result.concat(Constants.POINT).concat(Constants.SET_CREATEDAT).concat(Constants.PARENTHESE_OUVRANTE).concat(entryVariable).concat(Constants.POINT)
                .concat(Constants.GET_CREATEDAT).concat(Constants.PARENTHESE_FERMANTE).concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE));
        ...
        myWriter.write(result.concat(Constants.POINT).concat(Constants.SET_CURRENT_VERSION).concat(Constants.PARENTHESE_OUVRANTE).concat(entryVariable).concat(Constants.POINT)
                .concat(Constants.GET_CURRENT_VERSION).concat(Constants.PARENTHESE_FERMANTE).concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE));
        ...
        myWriter.write(result.concat(Constants.POINT).concat(Constants.SET_UPDATEDAT).concat(Constants.PARENTHESE_OUVRANTE).concat(entryVariable).concat(Constants.POINT)
                .concat(Constants.GET_UPDATEDAT).concat(Constants.PARENTHESE_FERMANTE).concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE));
        ...
        myWriter.write(result.concat(Constants.POINT).concat(Constants.SET_VERSION).concat(Constants.PARENTHESE_OUVRANTE).concat(entryVariable).concat(Constants.POINT)
                .concat(Constants.GET_VERSION).concat(Constants.PARENTHESE_FERMANTE).concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE));
    ...
    private void callTrackChildren(FileWriter myWriter, String entryVariable, String variableToSet) throws IOException {
        ...
        myWriter.write(variableToSet.concat(Constants.EGALE).concat(Constants.TRACK_CHILDREN_METHOD).concat(Constants.PARENTHESE_OUVRANTE).concat(entryVariable)
                .concat(Constants.VIRGULE).concat(variableToSet).concat(Constants.PARENTHESE_FERMANTE).concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE));
        ...
        if (childClass != null) {
            ...
            try {
                myWriter.write(AttributesTypeEnum.Set.toString().concat(Constants.INFERIEUR).concat(viewChildClassDto).concat(Constants.SUPERIEUR).concat(" ")
                        ...
                        .concat(Constants.PATTERN_POINT_VIRGULE__ET_RETOUR_LIGNE).concat(Constants.PATTERN_TABULATION).concat(Constants.PATTERN_TABULATION).concat(variableToSet)
    ...
    private void mappingRetrievedEntityToDto(BuisnessLogicEntity ent, FileWriter myWriter, String fileDto, String variableToSet, String entityToRetrieve) throws IOException {
        myWriter.write(Constants.PATTERN_TABULATION);
        myWriter.write(Constants.PATTERN_TABULATION);
    ...
    private void instanceObjectToReturn(BuisnessLogicEntity ent, FileWriter myWriter, String fileDto, String entryVariable, String variableToSet, String result)
            throws IOException {
    ...
    private void signatureMapToVersionDto(BuisnessLogicEntity ent, FileWriter myWriter, String fileDto, String entryVariable) throws IOException {
